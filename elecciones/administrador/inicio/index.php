...
?> 
<script>
	     window.history.pushState("object", "", "http://http://elecciones.mippci.gob.ve//administrador/usuarios/principal.php");
</script>
...
<!-------------------------------------------------------------------------------------------------------- 
                                           MENU VERTIVAL PARA TODOS LOS PERFIL
------------------------------------------------------------------------------------------------------->
<?php 
if ($id_rol == '1') {
...
<?php
                          $usu=$_GET["usu"];
                          switch ($usu) { 
                              case 1:require ("mensajes/bienvenida.php");                           
                              break;
